    ...
    <div class="container">
        <?php if (isset($data)) { ?>
            ...
            <div class="list-of-profile">
                ...
                <p>On our website, <a href="https://ctchicks.com">ctchicks</a> Escort Portal, you can find multiple ads for <a href="https://ctchicks.com/<?=$_GET['category'].'/'.$_GET['city'].'/'.$_GET['locality'].'/' ?>"><?= $area ?> call girls</a> who offer the best erotic services in this locality. If you're tired of searching for reliable call girls here and there, now search ctchicks.com with <?= $area ?> name and with just a few clicks, you can see gorgeous call girls near you.</p>
                ...
                <p>Our <a href="https://ctchicks.com/<?=$_GET['category'].'/'.$_GET['city'].'/'.$_GET['locality'].'/' ?>">escort service in <?= $area ?> </a> all our escorts wisely so they will not spoil your mood. We guarantee that if our <?= $area ?> call girls do not compromise and behave well, we will try to refund the full amount. Contact these models now and get a luxurious girlfriend experience at any private party or celebration. You can easily find online girls with numbers and see their real pictures, which helps save time. ctchicks also offers other different types of <?= $area ?> call girls, on the basis of age, color, body type, etc., who offer 24/7 services with no travel charges for nearby hotels or private property bunglows or rooms.</p>
