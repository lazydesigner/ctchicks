    ...
    <div class="container">
        <?php if (isset($data)) { ?>
            ...
            <div class="list-of-profile">
                ...
                <p>On our website, ctchicks Escort Portal, you can find multiple ads for <?= $area ?> call girls who offer the best erotic services in this locality. If you're tired of searching for reliable call girls here and there, now search ctchicks.com with <?= $area ?> name and with just a few clicks, you can see gorgeous call girls near you.</p>
